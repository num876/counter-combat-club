  ...
  return (
    <section className="py-24 bg-muted/10 border-y border-muted/30">
      <div className="container">
                  ...
                  <div
                    ...
                    className={`p-5 rounded-xl border transition-colors ${
                      venue.highlight
                        ...
                        : "bg-background border-muted/50 hover:border-muted"
                    }`}
                  >
        ...
        {/* Map for HQ */}
        <div className="relative rounded-2xl overflow-hidden aspect-video max-w-4xl mx-auto border border-muted/50 shadow-2xl grayscale hover:grayscale-0 transition-all duration-700">
          <iframe
